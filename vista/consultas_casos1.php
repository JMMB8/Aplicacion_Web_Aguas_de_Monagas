...
if(isset($_GET['tokentipo'])){
$TIPO_CASO=$_GET['tokentipo'];
}

if(isset($_POST['boton_buscar'])){
$TIPO_CASO=$_POST['TIPOS'];
$mes=$_POST['mes'];
...
{
if ($TIPO_CASO=="1")
$senten="SELECT * FROM $LA_TABLA WHERE fecha_rep!='0000-00-00' ORDER BY fecha ASC";
else
$senten="SELECT * FROM $LA_TABLA WHERE fecha_rep='0000-00-00' ORDER BY fecha ASC";
...
<input type="hidden" name="TIPOS" <?php echo "value='$TIPO_CASO'"; ?>>
<tr>
<td colspan="2">
...
<td align="center">
<?php echo "
<A href='form/tablaDatos_casos.php?arrowscasos=$datos[0]&TYPE=$TIPO_CASO' title='VER REGISTRO'>

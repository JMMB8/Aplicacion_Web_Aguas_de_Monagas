...
//$parro=mysql_query("SELECT * FROM $LA_TABLA WHERE condicion='A'");
?>
<!DOCTYPE html>
<html>
<head>
	...
	function confirmar_eliminar3()
{
	...
	if(x)
	{ header("Location: page_servicios.php"); return true;}
	else
	{ return false; }
}
...
<TR>
<TD><span class="Estilo1">MODULO PARA LOS SERVICIOS</span></TD>
<TD align="right">
...
<tr>
<td colspan="3">
<form name="fm1" action="page_servicios.php" method="POST">
<input type='text' class="contact_form1" name='campo' id='campo' placeholder="Nombre del servicio" onChange="javascript:this.value=this.value.toUpperCase();">
<button class="submit" name="boton_buscar" type='submit'>Buscar</button>
</form>
</td>
<td align="right" colspan="3">
<A href="form/form_servicio.php?Newmaq=0&TYPE=XHFGDHFGHDGH767HDGFH" title="REGISTRO NUEVO  SERVICIO">
<img src="../img/nuevos.png">
</A></td>
</tr>
<tr bgcolor="#000033">
<td align="center"><span class="Estilo2">N&deg;</span></td>
<td><span class="Estilo2">DESCRIPCI&Oacute;N DEL SERVICIO</span></td>
...
<td align='center'>
<?php echo "
<A href='form/form_servicio.php?Newmaq=$datos[0]&TYPE=CARGOS'>
...
<?php 
echo "
<A href='page_servicios.php?dropAlum=$datos[0]' title='Eliminar registro' onClick='return confirmar_eliminar3()'>

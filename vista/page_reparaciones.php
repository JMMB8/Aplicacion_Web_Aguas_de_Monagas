...
<script language="JavaScript" type="text/javascript">
 function Filtrar_sectores(){
			CargadorAjax.CargadorContenidos('../modelo/filtrar_sectores1.php', 'filtroSectores', 'POST', 'id_parroq='+$('id_parroq').value);
	}
function mensaje()
{
...
<TR>
<TD><span class="Estilo1">MODULO PARA EL REGISTRO DE REPARACIONES</span></TD>
<TD align="right">
...
$mes=$_GET['mes'];
$id_parroq=$_GET['id_parroq'];
//$id_sector=$_GET['id_sector'];
// AND id_sector='$id_sector'
	$El_mes=date("Y")."-".$mes;
	$senten="SELECT * FROM $LA_TABLA WHERE fecha LIKE '$El_mes%' AND id_parroquia='$id_parroq' AND fecha_rep='0000-00-00' ORDER BY fecha DESC";
...
<tr>
<td colspan="9">
<span class="Estilo3">Indique el mes y la parroquia, para registrar la fecha de reparación de los casos.</span>
</td>
</tr>
<tr>
<td colspan="2">
...
<form name="entrar" action="../controlador/redireccionasReparacion.php" method="POST">
Mes:
<?php
...
<td align="center">
<?php echo "
<A href='form/formulario_casos1.php?arrowscasos=$datos[0]&TYPE=CASOS' title='REGISTRAR REPARACI&Oacute;N'>
<img src='../img/b_save.png'>
</A>
"; ?>
</td>
<!--<td align="center">

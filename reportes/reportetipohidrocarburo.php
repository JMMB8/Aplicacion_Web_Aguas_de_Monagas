...
$LIM_MES=28;
  ...
  $meses=$anios."-".$mes;*/
  // echo "$meses"; 
  $SQL1=mysql_query("SELECT * FROM traslados WHERE tipo_carga='$CODIGO_MATERIAL' ORDER BY fecha_salida DESC");
...
<center>
<?php echo "<H3>SALIDAS DE TRANSPORTES CON LA CARGA DE: $DESCRIPCION_MATERIAL TOTAL: $NUM</h3>"; ?>
</center>
